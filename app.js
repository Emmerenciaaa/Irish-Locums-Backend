...
import DutyRousterRoute from "./Router/DutyRoster.js";
...
const swaggerOptions = {
  swaggerDefinition: {
    ...
    info: {
      ...
      contact: {
        name: "Hanis Hapsa, Andrew Ishaku",
        url: "https://irish-locums-api.onrender.com/",
        email: "hapsahanis.hh@gmail.com, wrefordmessi@gmail.com",
      },
    },
    servers: [
      {
...
app.use("/duties", DutyRousterRoute);
